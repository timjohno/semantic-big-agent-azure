...
- Please wtite a narrative about the risk profile of the business, using the financial_data. Write a bullet point for each piece of financial data. Once you have done this pause to ask for confirmation before proceeding.
